...
<head>
    ...
    <title><?= $title ?? 'Admin Rany Catering'; ?></title>
...
<div class="layout-container">
    ...
    <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
            <a href="<?= base_url('index.php/admin/dashboard') ?>" class="menu-link">
        ...
        <li class="menu-item">
            <a href="<?= base_url('index.php/admin/menu') ?>" class="menu-link">
        ...
        <li class="menu-item">
            <a href="<?= base_url('index.php/admin/paket') ?>" class="menu-link">
        ...
        <li class="menu-item">
            <a href="<?= base_url('index.php/admin/pemesanan') ?>" class="menu-link">
        ...
        <li class="menu-item">
            <a href="<?= base_url('index.php/admin/pembayaran') ?>" class="menu-link">
