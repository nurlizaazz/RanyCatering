...
<head>
    ...
    <title><?= $title ?? 'Pelanggan Rany Catering'; ?></title>
    ...
    <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
                ...
                <a href="<?= base_url('index.php/pelanggan/catering'); ?>"
                   class="menu-link">

                    <i class="menu-icon icon-base bx bx-food-menu"></i>

                    <div>Paket Catering</div>
            ...
            <li class="menu-item">
                ...
                <a href="<?= base_url('index.php/pelanggan/catering/pesanan-saya'); ?>"
                   class="menu-link">
            ...
            <li class="menu-item">
                ...
                <a href="<?= base_url('index.php/pelanggan/catering/riwayat') ?>"
                class="menu-link">
                ...
                <ul class="navbar-nav flex-row align-items-center ms-auto">
                    ...
                    <li class="nav-item me-3">
                        ...
                        <a class="nav-link position-relative"
                           href="<?= base_url('index.php/pelanggan/catering/keranjang'); ?>">

                            <i class="bx bx-cart bx-sm" style="font-size: 1.5rem;"></i>

                            <?php if(!empty(session()->get('keranjang'))): ?>
                    ...
                    <li class="nav-item navbar-dropdown dropdown-user dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <h6 class="mb-0">
                                                ...
                                                <?= session()->get('username') ?? 'Pelanggan'; ?>
                            ...
                            <li>
                                ...
                                href="<?= base_url('index.php/pelanggan/profil'); ?>">
